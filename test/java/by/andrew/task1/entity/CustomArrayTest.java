...
class CustomArrayTest {
    ...
    void testCreateCustomArrayWithValidArray() {
        ...
        CustomArray customArray = CustomArray.createCustomArray(array);
    ...
    void testEquals() {
        ...
        CustomArray customArray1 = CustomArray.createCustomArray(array1);
        CustomArray customArray2 = CustomArray.createCustomArray(array2);
        CustomArray customArray3 = CustomArray.createCustomArray(array3);
