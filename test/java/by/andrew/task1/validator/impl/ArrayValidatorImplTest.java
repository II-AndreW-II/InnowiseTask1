...
class ArrayValidatorImplTest {
    ...
    private static final String VALID_WHITESPACE_LINE = "   ";
    ...
    @Test
    void testIsEmptyLineWithEmptyString() {
        String line = VALID_EMPTY_LINE;
        ArrayValidatorImpl validator = new ArrayValidatorImpl();
        boolean result = validator.isEmptyLine(line);
        assertTrue(result);
    }

    @Test
    void testIsEmptyLineWithWhitespace() {
        String line = VALID_WHITESPACE_LINE;
        ArrayValidatorImpl validator = new ArrayValidatorImpl();
        boolean result = validator.isEmptyLine(line);
        assertTrue(result);
    }
    ...
    @Test
    void testIsEmptyLineWithNonEmpty() {
        String line = VALID_LINE_COMMA;
        ArrayValidatorImpl validator = new ArrayValidatorImpl();
        boolean result = validator.isEmptyLine(line);
        assertFalse(result);
